...
export const IPhoneFrame = ({
  ...
  return (
    <div className="sm:p-4 px-2 py-3 rounded-[28px]">
      <div
        className={clsx(
          'mx-auto p-[5px] bg-black rounded-[28px] w-[200px] h-[408px] relative  overflow-hidden cursor-pointer transition duration-300 ease-in-out',
